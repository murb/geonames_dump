class CreateGeonamesFeatures < ActiveRecord::Migration[6.0]
  ...
  def change
    ...
    add_index :geonames_features, :admin1_code, length: 20
    add_index :geonames_features, :type, length: 20
    add_index :geonames_features, :asciiname_first_letters, length: 3
  end
end
